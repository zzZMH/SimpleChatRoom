...
var eventproxy = require('eventproxy'); //流程控制(相当于计数器)
var ep = eventproxy();
var iconv = require('iconv-lite');

var baseUrl = 'http://www.dytt8.net';  //想要爬取的网页地址
var newMovieLinkArr=[]; //存放所需数据
var errLength=[];     //统计出错的链接数
var highScoreMovieArr=[]; //特殊个别数据
...
function highScoreMovie($){
    ...
    console.log(url);
    if($('.co_content2 ul a').eq(0).attr('href')){
        superagent
            .get(url)
            .charset('GB2312')
            .end(function (err, sres) {
